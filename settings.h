...
/*Filtersettings*/
gint32 filter_length = 8;		//It is always better to choose a Filterlength in the power of 2 (2,4,8,16,32,64,128,256,512,1024...)
...
#define debugmode 0			//Creates an own random input vector with rects, gives you more information about memory allocation and more.
#define harddebug 0					
