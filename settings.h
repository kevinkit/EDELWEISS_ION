...
/*Modes*/
#define safemode  1		//If safemode is set the program will exit if there are more peaks found wich are not expected than in the variable notexpect_max are defined.
...
#define debugmode  1			//Creates an own random input vector with rects, gives you more information about memory allocation and more.
#define harddebug  0			//shows you the created input vector			
